      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <h2 className="text-[32px] md:text-[64px] font-bold leading-[38px] md:leading-[77px] text-[#1D2939] w-3/5 md:w-4/5">
            Contact our <span className="text-[#1570EF]"> sales</span> team{" "}
          </h2>
          <p className="text-[#667085] mt-4 text-base font-normal leading-[28px] w-4/5">
            Get in touch to start your tech project—custom apps, cloud services,
        ...
        <form className="bg-white shadow-lg rounded-lg p-6 space-y-6">
          ...
          <button
            type="submit"
            className="w-[150px] bg-[#0C111D] text-white py-3 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex justify-center items-center"
          >
            Submit →
          </button>
        </form>
